...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-function-clusterApiUrl">
    <span class="access" data-ice="access">public</span>
    ...
    <span class="code" data-ice="name">clusterApiUrl</span><span class="code" data-ice="signature">(cluster: <span>*</span>, tls: <span>*</span>): <span>*</span></span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/util/cluster.js.html#lineNumber24">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {clusterApiUrl} from &apos;<span><a href="file/src/util/cluster.js.html#lineNumber24">@solana/web3</a></span>&apos;</code></pre></div>
  ...
  <table class="params">
    ...
    <tr data-ice="property" data-depth="0">
      <td data-ice="name" class="code" data-depth="0">cluster</td>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-function-decodeData">
    <span class="access" data-ice="access">public</span>
    ...
    <span class="code" data-ice="name">decodeData</span><span class="code" data-ice="signature">(type: <span>*</span>, buffer: <span>*</span>): <span>*</span></span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/instruction.js.html#lineNumber32">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {decodeData} from &apos;<span><a href="file/src/instruction.js.html#lineNumber32">@solana/web3</a></span>&apos;</code></pre></div>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-function-promiseTimeout">
    <span class="access" data-ice="access">public</span>
    ...
    <span class="code" data-ice="name">promiseTimeout</span><span class="code" data-ice="signature">(promise: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span>T</span>&gt;, timeoutMs: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span>): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span>T</span>|<span>nullliteral</span>&gt;</span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/util/promise-timeout.js.html#lineNumber3">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {promiseTimeout} from &apos;<span><a href="file/src/util/promise-timeout.js.html#lineNumber3">@solana/web3</a></span>&apos;</code></pre></div>
  ...
  <table class="params">
    ...
    <tr data-ice="property" data-depth="0">
      <td data-ice="name" class="code" data-depth="0">promise</td>
      <td data-ice="type" class="code"><span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span>T</span>&gt;</td>
      <td data-ice="appendix"></td>
      <td data-ice="description"></td>
    </tr>
<tr data-ice="property" data-depth="0">
      <td data-ice="name" class="code" data-depth="0">timeoutMs</td>
      <td data-ice="type" class="code"><span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></td>
      <td data-ice="appendix"></td>
      <td data-ice="description"></td>
    </tr>
  ...
  <div class="return-params" data-ice="returnParams">
    ...
    <table>
      <tbody>
        <tr>
          <td class="return-type code" data-ice="returnType"><span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span>T</span>|<span>nullliteral</span>&gt;</td>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-function-sendAndConfirmRawTransaction">
    ...
    <span class="code" data-ice="name">sendAndConfirmRawTransaction</span><span class="code" data-ice="signature">(connection: <span><a href="class/src/connection.js~Connection.html">Connection</a></span>, rawTransaction: <span>Buffer</span>, options: <span><a href="typedef/index.html#static-typedef-ConfirmOptions">ConfirmOptions</a></span>): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span><a href="typedef/index.html#static-typedef-TransactionSignature">TransactionSignature</a></span>&gt;</span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/util/send-and-confirm-raw-transaction.js.html#lineNumber17">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {sendAndConfirmRawTransaction} from &apos;<span><a href="file/src/util/send-and-confirm-raw-transaction.js.html#lineNumber17">@solana/web3</a></span>&apos;</code></pre></div>
  
  
  <div data-ice="description"><p>Send and confirm a raw transaction</p>
<p>If <code>commitment</code> option is not specified, defaults to &apos;max&apos; commitment.</p>
</div>
...
<tr data-ice="property" data-depth="0">
      ...
      <td data-ice="type" class="code"><span><a href="typedef/index.html#static-typedef-ConfirmOptions">ConfirmOptions</a></span></td>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-function-sendAndConfirmTransaction">
    ...
    <span class="code" data-ice="name">sendAndConfirmTransaction</span><span class="code" data-ice="signature">(connection: <span><a href="class/src/connection.js~Connection.html">Connection</a></span>, transaction: <span><a href="class/src/transaction.js~Transaction.html">Transaction</a></span>, signers: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array">Array</a></span>&lt;<span><a href="class/src/account.js~Account.html">Account</a></span>&gt;, options: <span><a href="typedef/index.html#static-typedef-ConfirmOptions">ConfirmOptions</a></span>): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span><a href="typedef/index.html#static-typedef-TransactionSignature">TransactionSignature</a></span>&gt;</span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/util/send-and-confirm-transaction.js.html#lineNumber20">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {sendAndConfirmTransaction} from &apos;<span><a href="file/src/util/send-and-confirm-transaction.js.html#lineNumber20">@solana/web3</a></span>&apos;</code></pre></div>
